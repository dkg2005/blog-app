...
class BlogPostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blog_post" do
    assert_difference("BlogPost.count") do
      post blog_posts_url, params: { blog_post: { author_id: @blog_post.author_id, body: @blog_post.body, summary: @blog_post.summary, tags: @blog_post.tags, title: @blog_post.title } }
    end
  ...
  test "should update blog_post" do
    patch blog_post_url(@blog_post), params: { blog_post: { author_id: @blog_post.author_id, body: @blog_post.body, summary: @blog_post.summary, tags: @blog_post.tags, title: @blog_post.title } }
